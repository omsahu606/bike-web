				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
						  ...
						  <li><a href="modelss.php">Models</a></li>
						  <li><a href="login.html">Book</a></li>
						  <li><a href="Assessoriess.php">Accessories</a></li>
						  <li><a href="login.html">Enquiry</a></li>
				  ...
				  <!-- ✅ Fixed Dropdown -->
						  <li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
							  ...
							  <li><a href="logadmin.html">ADMIN</a></li>
							</ul>
						  </li>

							<li><a href="contactus.php">Sign-Up</a></li>
						</ul>
					</div>
				</div>
			</nav>
		...
		<section id="models">
			...
			<section id="Book">
				<div class="image-buttono">
					<a href="login.html"><img src="image/zigwheels-detail.jpg"alt="image"></a>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="well-om">
							<div class="row">
								<div class="col-md-6">
									<a href="Assessoriess.php"><div class="thumbnail om">
