				...
				<div class="col-md-12">
							...
							<div class="col-md-4">
								<div class="thumbnail om">
									<a href="login.html?a_id=<?php echo $row['a_id'];?>" class="category-btn">
								
									<a href="login.html?a_id=<?php echo $row['a_id'];?>"><img src="../Bike-showroom/mimg/sefty/<?PHP echo $row['file']?>" alt="Fjords"></a>
									</a>
