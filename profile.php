  ...
  <div class="container">
		<div class="col-sm-4">
				  ...
				  <p>om1@gmail.com</p>
						...
						$query1="select *from users_tbl where u_id='$uid'";
							...
							if(isset($_POST['update']))
							{
								...
								$query1 = "update users_tbl set fname='$fname', lname='$lname', email='$email', phone='$phone' where u_id ='$uid'";
			...
			<?php
										...
										$sql2="select * from address_tbl where u_id = '$uid'";
